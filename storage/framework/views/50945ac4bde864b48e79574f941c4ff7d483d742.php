<?php $__env->startSection('page-header'); ?>
    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(url('/' . ($page = '#'))); ?>"><i
                            class="fe fe-home mr-2 fs-14"></i>Home</a></li>
                <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('/' . ($page = '#'))); ?>">Sales
                        Dashboard</a></li>
            </ol>
        </div>
        <div class="page-rightheader">
            <div class="btn btn-list">
                <a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="btn btn-info"><i class="fe fe-settings mr-1"></i>
                    General
                    Settings </a>
                <a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="btn btn-danger"><i class="fe fe-printer mr-1"></i>
                    Print
                </a>
                <a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="btn btn-warning"><i class="fe fe-shopping-cart mr-1"></i>
                    Buy Now </a>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-options">
                        <a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="option-dots" data-toggle="dropdown"
                        ...
                        <ul class="timeline mb-0">
                            <li class="mt-0">
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Joseph Ellison</span> finished
                                    task on<a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="font-weight-semibold">
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Elizabeth Scott</span> Product
                                    delivered<a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="font-weight-semibold">
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Sonia Peters</span> finished
                                    target on<a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="font-weight-semibold">
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Justin Nash</span> source report
                                    on<a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="font-weight-semibold">
                                        Generated</a></p>
                            </li>
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Ella Lambert</span> ontime order
                                    delivery <a href="<?php echo e(url('/' . ($page = '#'))); ?>"
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Nicola Blake</span> visit the
                                    site<a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="font-weight-semibold">
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Richard Mills</span> source
                                    report on<a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="font-weight-semibold">
                                        Generated</a></p>
                            </li>
                            <li class="mb-0">
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Steven Hart</span> is proces the
                                    order<a href="<?php echo e(url('/' . ($page = '#'))); ?>" class="font-weight-semibold">
                                        #987</a></p>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col-9 col-sm-9">
                                <div class="media mt-0">
                                    <img src="<?php echo e(URL::asset('admin_assets/images/users/1.jpg')); ?>" alt="img"
                    ...
                    <div class="list-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-9 col-sm-9">
                                <div class="media mt-0">
                                    <img src="<?php echo e(URL::asset('admin_assets/images/users/9.jpg')); ?>" alt="img"
                                        class="avatar brround avatar-md mr-3">
                                    <div class="media-body">
                                        <div class="d-md-flex align-items-center mt-1">
                    ...
                    <div class="list-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-9 col-sm-9">
                                <div class="media mt-0">
                                    <img src="<?php echo e(URL::asset('admin_assets/images/users/2.jpg')); ?>" alt="img"
                                        class="avatar brround avatar-md mr-3">
                                    <div class="media-body">
                                        <div class="d-md-flex align-items-center mt-1">
                    ...
                    <div class="list-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-9 col-sm-9">
                                <div class="media mt-0">
                                    <img src="<?php echo e(URL::asset('admin_assets/images/users/11.jpg')); ?>" alt="img"
                                        class="avatar brround avatar-md mr-3">
                                    <div class="media-body">
                                        <div class="d-md-flex align-items-center mt-1">
                    ...
                    <div class="list-card">
                        ...
                        <div class="row align-items-center">
                            <div class="col-9 col-sm-9">
                                <div class="media mt-0">
                                    <img src="<?php echo e(URL::asset('admin_assets/images/users/3.jpg')); ?>" alt="img"
                                        class="avatar brround avatar-md mr-3">
                                    <div class="media-body">
                                        <div class="d-md-flex align-items-center mt-1">
                                            <h6 class="mb-1">Joseph Abraham</h6>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="country-card">
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="<?php echo e(URL::asset('admin_assets/images/flags/us.svg')); ?>"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="<?php echo e(URL::asset('admin_assets/images/flags/in.svg')); ?>"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="<?php echo e(URL::asset('admin_assets/images/flags/ru.svg')); ?>"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="<?php echo e(URL::asset('admin_assets/images/flags/ca.svg')); ?>"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="<?php echo e(URL::asset('admin_assets/images/flags/ge.svg')); ?>"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="<?php echo e(URL::asset('admin_assets/images/flags/br.svg')); ?>"
                        ...
                        <div class="mb-0">
                            <div class="d-flex">
                                <span class=""><img src="<?php echo e(URL::asset('admin_assets/images/flags/au.svg')); ?>"
                            ...
                            <tbody>
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="<?php echo e(URL::asset('admin_assets/images/orders/7.jpg')); ?>" alt="media1">
                                        New Book</td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="<?php echo e(URL::asset('admin_assets/images/orders/8.jpg')); ?>" alt="media1">
                                        New Bowl</td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="<?php echo e(URL::asset('admin_assets/images/orders/9.jpg')); ?>" alt="media1">
                                        Modal Car</td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="<?php echo e(URL::asset('admin_assets/images/orders/10.jpg')); ?>" alt="media1">
                                        Headset</td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="<?php echo e(URL::asset('admin_assets/images/orders/12.jpg')); ?>" alt="media1">
                                        Watch</td>
                                ...
                                <tr>
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="<?php echo e(URL::asset('admin_assets/images/orders/13.jpg')); ?>" alt="media1">
                                        Branded Shoes</td>
                                ...
                                <tr class="mb-0">
                                    <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                            src="<?php echo e(URL::asset('admin_assets/images/orders/11.jpg')); ?>" alt="media1">
                                        New EarPhones</td>
